...
const getHoveredRowId = (state: StoreState) => getState(state).hoveredRowId;

const ListSelectors = { getRows, getIsLoading, getSelectedRowIds, getPagination, getIsRowSelected, getHoveredRowId };
